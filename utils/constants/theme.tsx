...
export const FONTS = {
    ...
    h1: { fontFamily: "Poppins-Medium", fontWeight: Platform.OS === "android" ? 700 : "500", fontSize: SIZES.h1, lineHeight: 35, color: COLORS.black },
    h2: { fontFamily: "Poppins-Medium", fontWeight: Platform.OS === "android" ? 700 : "500", fontSize: SIZES.h2, lineHeight: 30, color: COLORS.black },
    h3: { fontFamily: "Poppins-Medium", fontWeight: Platform.OS === "android" ? 700 : "500", fontSize: SIZES.h3, lineHeight: 22, color: COLORS.black },
    h4: { fontFamily: "Poppins-Medium", fontWeight: Platform.OS === "android" ? 700 : "500", fontSize: SIZES.h4, lineHeight: 22, color: COLORS.black },
    h5: { fontFamily: "Poppins-Medium", fontWeight: Platform.OS === "android" ? 700 : "500", fontSize: SIZES.h5, lineHeight: 22, color: COLORS.black },
